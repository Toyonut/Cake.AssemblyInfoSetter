...
[assembly: AssemblyFileVersion(""1.0.0.0"")]
		...
		var actualAssemblyInfo = csReplacer.ReplaceProperties(initialAssemblyInfo, propertiesDict);

		Assert.AreEqual(expectedAssemblyInfo, actualAssemblyInfo);
	}

	[TestMethod]
	public void ShouldNotReplacePropertyInCommentsAssemblyInfoCs()
	{
		var initialAssemblyInfo = @"
using System.Reflection;
using System.Runtime.InteropServices;
